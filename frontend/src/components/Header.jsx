  ...
  return (
    <header className="h-16 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-6 flex items-center justify-between sticky top-0 z-40">
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 border border-emerald-500/40 shadow-lg shadow-emerald-500/10">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-base font-bold tracking-wider text-white uppercase flex items-center gap-1.5 font-mono">
              SENTINEL <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-sans tracking-normal">STATEWIDE VMS</span>
            </h1>
          </div>
          <p className="text-[11px] text-slate-400 font-medium">Gujarat Police Innovation Challenge 2026 • SCRB Command Grid</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-lg bg-cyan-950/40 border border-cyan-500/40 text-cyan-300 hover:bg-cyan-900/40 transition flex items-center gap-1.5 text-xs font-medium"
        ...
        <button
          ...
          className="px-3.5 py-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-medium shadow-md shadow-emerald-950/40 flex items-center gap-1.5 text-xs transition active:scale-95"
        >
