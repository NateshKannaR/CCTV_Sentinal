...
export default function Sidebar({ 
  ...
  return (
    <aside 
      className={`h-[calc(100vh-4rem)] bg-slate-900/95 backdrop-blur-md border-r border-slate-800 flex flex-col justify-between transition-all duration-300 z-30 select-none ${
        collapsed ? 'w-20' : 'w-64'
      }`}
    >
      {/* Navigation Group */}
