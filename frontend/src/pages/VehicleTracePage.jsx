...
export default function VehicleTracePage({
  ...
  return (
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 max-w-[1700px] mx-auto">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-rose-950/40 border border-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-rose-500/10 text-rose-400 rounded-xl border border-rose-500/30 flex-shrink-0">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2.5 rounded-xl bg-cyan-950/60 border border-cyan-500/50 hover:bg-cyan-900/50 text-cyan-300 font-semibold text-xs flex items-center justify-center gap-2 transition"
        >
