...
export default function WatchlistPage({
  ...
  return (
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 max-w-[1700px] mx-auto">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-amber-950/40 border border-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 bg-amber-500/10 text-amber-400 rounded-xl border border-amber-500/30 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 font-mono text-[11px] sm:text-xs text-slate-300 bg-slate-950/80 px-3 sm:px-4 py-2 rounded-xl border border-slate-800">
          <Database className="w-4 h-4 text-emerald-400 flex-shrink-0" />
          <span className="truncate">SYNCED: STATE CRIME RECORDS BUREAU</span>
        </div>
      </div>
